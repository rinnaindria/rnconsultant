  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">RN Consultant</h1>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Layanan</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="#">Jasa Konsultasi Pajak</a></li>
  ...
  <main class="main">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <h2>Solusi Cerdas Perpajakan Anda</h2>
            <p class="lead">Lupakan kerumitan pajak. RN Consultan hadir dengan solusi perpajakan premium yang membuat pengelolaan pajak bisnis Anda menjadi lebih efisien, akurat, dan bebas risiko</p>
    ...
    <section id="about" class="about section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Vorentax hadir sebagai jawaban atas kebutuhan pengelolaan pajak yang profesional dan terpercaya. 
          Didirikan dengan semangat untuk membantu ratusan pebisnis dalam mengoptimalkan kepatuhan pajak mereka</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-content">
              ...
              <p class="lead mb-4">Menjadi partner terpercaya dalam solusi perpajakan di Indonesia</p>
              <h2>MISI</h2>

              <li class="lead mb-4">Menjadi partner terpercaya dalam solusi perpajakan di Indonesia</li>
    ...
    <section id="portfolio" class="portfolio section">
      ...
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Melayani Industri</h2>
        <div class="title-shape">
          <svg viewBox="0 0 200 20" xmlns="http://www.w3.org/2000/svg">
            <path d="M 0,10 C 40,0 60,20 100,10 C 140,0 160,20 200,10" fill="none" stroke="currentColor" stroke-width="2"></path>
          </svg>
        </div>
        <p>Setiap industri memiliki tantangan perpajakan yang berbeda. Kami memahami hal ini dan menyediakan 
          solusi yang disesuaikan dengan kebutuhan spesifik bisnis Anda, dari manufaktur hingga startup teknologi</p>
      </div><!-- End Section Title -->
    ...
    <section id="testimonials" class="testimonials section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Mulai Optimalisasi Pajak
        Bisnis Anda Sekarang</p>
        <div class="container py-5">
  <div class="row g-4">
    <!-- Paket UMKM -->
    <div class="col-md-4">
      <div class="card">
        <div class="card-header" style="background-color : #2bdff0;">Paket UMKM<br><small>Cocok untuk perusahaan dengan omzet maksimal 100 juta / tahun</small></div>
        <div class="card-body text-center">
          <div class="price">Rp 2 jt</div>
          <div class="text-muted mb-4">/ Bulan</div>
          <ul class="feature-list text-start">
            <li>Perhitungan & Pelaporan PPh 21/26</li>
            <li>Perhitungan & Pelaporan PPh 23</li>
            <li>Perhitungan & Pelaporan PPh UMKM</li>
            <li>Perhitungan & Pelaporan PPh 4 Ayat (2)</li>
            <li>Laporan Laba/Rugi, Neraca, Buku Besar</li>
            <li>Konsultasi Pajak</li>
          </ul>
          <button class="btn btn-custom mt-3">Chat Us</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card position-relative">
        <div class="badge-top" style="background-color : #2bdff0;">TERLARIS</div>
        <div class="card-header" style="background-color : #2bdff0;">Paket Bisnis<br><small>Cocok untuk perusahaan dengan omzet 100 juta - 4,8 miliar / tahun</small></div>
        <div class="card-body text-center">
          <div class="price">Rp 3 jt</div>
          <div class="text-muted mb-4">/ Bulan</div>
          <ul class="feature-list text-start">
            <li>Perhitungan & Pelaporan PPh 21/26</li>
            <li>Perhitungan & Pelaporan PPh 23</li>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header" style="background-color : #2bdff0;">Full PKP<br><small>Cocok untuk perusahaan yang sudah mengukuhkan PKP</small></div>
        <div class="card-body text-center">
          <div class="price">Rp 5 jt</div>
          <div class="text-muted mb-4">/ Bulan</div>
          <ul class="feature-list text-start">
            <li>Perhitungan & Pelaporan PPh 21/26</li>
            <li>Perhitungan & Pelaporan PPh 23</li>
            <li>Perhitungan & Pelaporan PPh UMKM</li>
            <li>Perhitungan & Pelaporan PPh 4 Ayat (2)</li>
            <li>Perhitungan & Pelaporan PPN</li>
            <li>Laporan Laba/Rugi, Neraca, Buku Besar</li>
            <li>Pendampingan jika ada pemeriksaan oleh DJP</li>
            <li>Konsultasi Pajak</li>
          </ul>
          <button class="btn btn-custom mt-3">Chat Us</button>
        </div>
